...
fig.savefig(SALIDAS + 'CA_Temp_MediaEstacional_GISS.png', dpi=300, bbox_inches='tight')
...
fig.savefig(SALIDAS + 'CA_Temp_MediaEstacional_CRU.png', dpi=300, bbox_inches='tight')
