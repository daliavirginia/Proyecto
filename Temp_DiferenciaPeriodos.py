...
#Por eso selecciono la variable ["tempanomaly"]. 
im=ax.contourf(lons, lats, ds_djf_dif["tempanomaly"],cmap="RdYlGn",levels=np.arange(-0.3,1.8,0.1),extend='both',transform=crs_latlon)
...
im=ax.contourf(lons, lats, ds_mam_dif["tempanomaly"],cmap="RdYlGn",levels=np.arange(-0.3,1.8,0.1),extend='both',transform=crs_latlon)
...
im=ax.contourf(lons, lats, ds_jja_dif["tempanomaly"],cmap="RdYlGn",levels=np.arange(-0.3,1.8,0.1),extend='both',transform=crs_latlon)
...
im=ax.contourf(lons, lats, ds_son_dif["tempanomaly"],cmap="RdYlGn",levels=np.arange(-0.3,1.8,0.1),extend='both',transform=crs_latlon)
...
fig.savefig(SALIDAS + 'DiferenciaPeriodosTemp.png', dpi=300, bbox_inches='tight')
